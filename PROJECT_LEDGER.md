...
- Current reconciled public-source overlay covers **60/149 galaxies = 44 calibration + 16 blind**.
- **30 galaxies now have an actual recovered/ingested profile or analytic model = 23 calibration + 7 blind**.
...
- Current untouched pool after public-source overlay: **89 galaxies** across **37 reference families**; **10** are currently actionable before applying newly landed dispositions.
...
**Current resume point:** **Bl99 — Blais-Ouellette et al.**: 1 untouched frozen galaxies (0 calibration + 1 blind): NGC5585.
