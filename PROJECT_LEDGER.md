...
- Current untouched pool after public-source overlay: **88 galaxies** across **35 reference families**; **1** are currently actionable before applying newly landed dispositions.
...
**Current resume point:** **Ri15 — Richards et al.**: 1 untouched frozen galaxies (0 calibration + 1 blind): NGC5005.
